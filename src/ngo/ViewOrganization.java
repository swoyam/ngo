 ...
 * @author memoshakya
 */
public class ViewOrganization extends javax.swing.JFrame {
    ...
    public ComboBoxModel getModelForSectorComboBox(TreeMap<Integer, String> inputMap) {
        ...
        for (Map.Entry<Integer, String> entry : inputMap.entrySet()) {
            vector.add(new ViewOrganization.Item(entry.getKey(), entry.getValue()));
        }
    ...
    public void setValues(Map<String, Object> valueMap) {
        ...
        this.sectorComboBox.setEditable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewOrganization.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewOrganization().setVisible(true);
            }
        });
    }
